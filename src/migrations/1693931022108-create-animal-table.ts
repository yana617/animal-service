...
export class CreteAnimalTable1693931022108 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query('CREATE TYPE "public"."animal_status_enum" AS ENUM(\'homeless\', \'adopted\', \'preparation\', \'died\', \'lost\', \'on-probation\')');
    await queryRunner.query('CREATE TABLE "animal" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "type" "public"."animal_type_enum" NOT NULL, "place" "public"."animal_place_enum" NOT NULL, "room" integer, "birthday" TIMESTAMP NOT NULL, "sex" "public"."animal_sex_enum" NOT NULL, "description" character varying, "health_details" character varying, "second_birthday" TIMESTAMP NOT NULL, "status" "public"."animal_status_enum" NOT NULL, "advertising_text" character varying, "height" integer, "sterilized" boolean NOT NULL DEFAULT false, "taken_home_date" TIMESTAMP, "curator_id" character varying, CONSTRAINT "PK_af42b1374c042fb3fa2251f9f42" PRIMARY KEY ("id"))');
  }
